$(function () {
    ...
    $('.btn a').click(function() {
        ...
        if (isAndroid) {
            $("#btn a").attr("class","android");
            if(isWeChat()){
                weChatRes('images/tips_weixin_android.png');
            }else{
                window.location.href = 'http://www.pettap.cn/package/app-prod-release.apk';
            }
        }
        if (isIOS) {
            $("#btn a").attr("class","ios");
            if(isWeChat()){
                ...
                window.location.href = 'https://itunes.apple.com/cn/app/宠爱之家-给流浪猫狗一个家/id1461730186?mt=8';
            }
        }
    });
