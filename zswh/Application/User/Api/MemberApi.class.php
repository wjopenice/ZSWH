...
class MemberApi extends Api{
    ...
    public function register($account, $password,$email,$truename,$idcard,$register_way=0,$promote_id=0,$promote_account="自然注册",$phone=""){
        return $this->model->register($account, $password,$email,$truename,$idcard,$register_way,$promote_id,$promote_account,$phone);
    }
    /**
     ...
     * @return integer          注册成功-用户信息，注册失败-错误编号
     */
    public function register_($account, $password,$real_name,$idcard,$register_way=0,$promote_id=0,$promote_account="自然注册",$phone="",$game_id=0,$game_name=""){
        return $this->model->register_($account,$password,$real_name,$idcard,$register_way,$promote_id,$promote_account,$phone,$game_id,$game_name);
    }

    public function register2_($account, $password,$real_name,$idcard,$register_way=0,$promote_id=0,$promote_account="自然注册",$phone="",$game_id=0,$game_name=""){
        return $this->model->register2_($account,$password,$real_name,$idcard,$register_way,$promote_id,$promote_account,$phone,$game_id,$game_name);
    }
    /**
     * 注册一个新用户
     * @param  string $account 用户名
    ...
    public function login2_($account, $password,$type=2,$game_id=0,$game_name='',$sdk_version=""){
        return $this->model->login2_($account, $password,$type,$game_id,$game_name,$sdk_version);
    }
    /**
    *修改数据
    */
