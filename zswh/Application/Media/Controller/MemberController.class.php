...
class MemberController extends BaseController {
  ...
  private $_cache;
    ...
    */
     ...
     * @author whh
     */
    public function telsvcode2($phone=null,$delay=10,$flag=true) {
        if (empty($phone)) {
            echo json_encode(array('status'=>0,'msg'=>'手机号不能为空'));exit;
        }
