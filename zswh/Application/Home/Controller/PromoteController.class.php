    ...
    */
    ...
    public function beginpay(){
        ...
        $vo->setBody("平台币充值")
            ...
            ->setPromoteNickname($promote['nickname'])
            ->setParentId($promote['parent_id'])
            ->setParentAccount($paccount['account'])
...
//                    $html ='<div class="d_body" style="height:10px;">
//                            <div class="d_content">
...
//                }else{
//                    $html ='<div class="d_body" style="height:100px;">
//                            <div class="d_content">
