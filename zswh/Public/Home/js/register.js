...
$(function() {
    ...
    jQuery.validator.addMethod('isPerson',function(values,element) {
        var person_a = /^[\u4e00-\u9fa5]{2,5}$/;
        return this.optional(element) || (person_a.test(values));
    },'联系人格式不正确，请重新输入');
	$('#login_form').validate({
        rules: {
