...
$("#reaccount").blur(function(){
    ...
    if (/^[a-zA-Z]+[0-9a-zA-Z_]{5,14}$/.test($("#reaccount").val())){
        ...
        $.ajax({
            ...
            url:'http://www.zhishengwh.com/media.php?s=/Member/checkUser',
...
$('#finished').click(function () {
    ...
    $.ajax({
        ...
        async: true,
        dataType: 'json',
        url:'http://www.zhishengwh.com/media.php?s=/Member/user_register',
            ...
            if (parseInt(data.status) == 1 ) {
                setTimeout(function() {
                    $.ajax({
                        ...
                        async: true,
                        dataType: 'json',
                        url: 'http://www.zhishengwh.com/media.php?s=/Member/login',
                        beforeSend:function(){
                        ...
                        success: function(data) {
                          if (parseInt(data.status) == 1 ) {
                              window.location.href='http://www.zhishengwh.com/media.php?s=/Member/personalcenter';
                          }
                        },
                        error: function() {
                            location.reload();
...
$("#reaccount2").blur(function(){
    ...
    if(/^1[3|4|5|7|8][0-9]{9}$/.test($("#reaccount2").val())){
        ...
        $.ajax({
            type: 'post',
            url: 'http://www.zhishengwh.com/media.php?s=/Member/checkPhone', //MODULE+'Member/checkPhone'
            async:false,
...
$('#ident').click(function (){
   ...
   // alert($.trim($('#reaccount2').val()))
    $.ajax({
        type: 'post',
        url: 'http://www.zhishengwh.com/media.php?s=/Member/telsvcode',
...
$('#finished2').click(function () {
    ...
    // 新修改的ajax
     $.ajax({
        ...
        url:'http://www.zhishengwh.com/media.php?s=/Member/telregister',
        beforeSend: function() {
