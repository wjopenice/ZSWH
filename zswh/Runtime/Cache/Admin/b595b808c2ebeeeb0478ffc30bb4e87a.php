...
<link rel="stylesheet" href="/Public/Admin/css/kendo.dataviz.min.css" />
<link rel="stylesheet" href="/Public/Admin/css/kendo.default.min.css" />
<link rel="stylesheet" href="/Public/Admin/css/kendo.rtl.min.css" />
<script src="/Public/Admin/js/kendo.dataviz.min.js"></script>
<script src="/Public/Admin/js/kendo.timezones.min.js"></script>
    <!-- 主体 -->
    <div id="indexMain" class="index-main">
       <!-- 插件块 -->
       <div class="container-span aiwrap"><?php echo hook('AdminIndex');?></div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.copyright').html('<div class="copyright" style="border-top:0;"> &copy;2018-2020 深圳致晟文化创新有限公司版权所有</div>');
        $('.sidebar').remove();
    })
</script>
