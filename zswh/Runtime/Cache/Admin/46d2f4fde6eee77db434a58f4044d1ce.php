...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
            ...
            <div class="sleft">
                <input type="text" name="<?php echo ((isset($model['search_key']) && ($model['search_key'] !== ""))?($model['search_key']):'agents_name'); ?>" class="search-input" value="<?php echo I('agents_name');?>" placeholder="请输入转入账号">
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('BangPropay/movebanglist','model='.$model['name'],false);?>">搜索</a>
            </div>
            <div class="input-list">
                <a class="sch-btn" href="<?php echo U('Export/expUser',array('id'=>18,'agents_name'=>I('agents_name'),'game_name'=>I('game_name'),'promote_account'=>I('promote_account'),'time-start'=>I('time-start'),'time-end'=>I('time-end'),'start'=>I('start'),'end'=>I('end'),));?>">导出</a>
...
//导航高亮
highlight_subnav('<?php echo U('BangPropay/movebanglist');?>');
$(function(){
     $('.ids').ready(function(){
