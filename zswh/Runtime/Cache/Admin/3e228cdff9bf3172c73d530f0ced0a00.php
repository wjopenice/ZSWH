...
<body>
	...
	<div class="cf top_nav_list">
        <div class="fl button_list">
            <a class="btn blue" id="dtn" href="javascript:;">批量修改</a>
		...
		<div class="search-form fr cf">
            ...
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('BangPropay/bind_balance_edit_list','model='.$model['name'],false);?>">搜索</a>
            </div>
            <div class="input-list">
                <a class="sch-btn" href="<?php echo U('Export/expUser',array('id'=>19,'game_name'=>I('game_name'),'time-start'=>I('time-start'),'time-end'=>I('time-end'),'start'=>I('start'),'end'=>I('end'),));?>">导出</a>
...
//导航高亮
highlight_subnav('<?php echo U("BangPropay/bind_balance_edit_list");?>');
$(function(){
     $('.ids').ready(function(){
  ...
  var spCodesTemp = "";
      ...
      if(spCodesTemp==""){
        ...
        $(this).attr('href','/admin.php?s=/BangPropay/batch_edit/ids/'+spCodesTemp);
      }
...
$('#time-start').datetimepicker({
  ...
  var spCodesTemp = "";
      ...
      if(spCodesTemp==""){
        ...
        $(this).attr('href','/admin.php?s=/BangPropay/delprovide_edit/ids/'+spCodesTemp);
      }
