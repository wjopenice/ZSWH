...
<div class="container-span top-columns cf" style="display: flex;margin: 1.4% 0;">
    <dl style="flex: 1;margin: 0 1% 0 0;" class="show-num-mod col_01">
    ...
    <dl style="flex: 1;margin: 0 1% 0 0;" class="show-num-mod col_05">
    ...
    <dl style="flex: 1;margin: 0 1% 0 0;" class="show-num-mod col_03">
    ...
    <dl style="flex: 1;margin: 0 1% 0 0;" class="show-num-mod col_02">
    ...
    <dl style="flex: 1;margin: 0" class="show-num-mod col_04">
...
<div style="overflow: hidden;margin-bottom: 2%;">
    <div style="width: 49%;float: left" class="span2" >
    ...
    <div style="width: 49%;float: right;" class="span2" >
        <div class="columns-mod">
            <div class="hd cf">
                <h5>最近 7 天注册概况</h5>
                <div class="title-opt">
