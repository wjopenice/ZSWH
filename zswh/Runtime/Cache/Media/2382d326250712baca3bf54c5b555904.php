...
<div class="top " id="topPart">
    <div class="container">
        <div class="top-l">
            ...
            <a target="_blank" href="http://open.zhishengwh.com/forum.php"> 游戏论坛 ｜</a>
            <a target="_blank" href="/index.php?s=/Home/Index/index.html"> 渠道平台 </a>
...
<div class="header clearfix" id="navBar">
    <div class="center">
        <h1 class="header-l">
             <a href="<?php echo U('Index/index');?>" class="logo"><img src="/Public/Media/image/header/logo.png" alt="玩转平台"></a>
        </h1>
        <div class="header-c">
            <ul class="list">
                ...
                <li><span class="menu-7"></span><a href="<?php echo U('Exchange/index');?>">兑换中心</a></li>
                ...
                <li><span class="menu-8"></span><a target="_blank" href="/media.php?s=/Index/about">关于我们</a></li>
            </ul>
        </div>
        <div class="header-r">
...
<div class="pc_main">
    ...
    var ACTION_STR = '/index.php?s=/Media/Index/index';
    var MODULE = "/index.php?s=/Media";
...
<!--轮播图-->
    <style>
        .game .game-right .libao{margin-top: 0;}
        /*      公共title_box       */
        ...
        .pic .pic1{width: 300px;height: 400px;position: relative;float: left;overflow: hidden;}
        .pic .pic1 a{display: inline-block;}
        .pic .pic1 .show{position: absolute;bottom: 0;left: 0;width: 100%;height: 100%;background: url("/Public/Media/image/medal.png") left top repeat;display: none;}
        .pic .pic1 .show .show-content{width: 300px;height: 400px;line-height: 400px;}
        .pic .pic1 .show .show-content a{font-size: 16px;display: block;color: #fff;text-align: center;}
        .pic .pic1:hover .show{display: block;}
        .pic .pic2{width: 400px;height: 400px;float: left;}
        .pic .pic2 .pic2-t{position: relative;float: left;}
        .pic .pic2 .pic2-t .one{width: 400px;height: 200px;display: block;}
        .pic .pic2 .pic2-t .one img{display: inline-block;}
        .pic .pic2 .pic2-t .show{position: absolute;top: 0;left: 0;width: 400px;height: 200px;background: url("/Public/Media/image/medal.png") left top repeat;display: none;}
        .pic .pic2 .pic2-t .show a{font-size: 16px;display: block;color: #fff;text-align: center;width: 400px;height: 200px;line-height: 200px;}
        .pic .pic2 .pic2-t:hover .show{display: block;}
        .pic .pic2 .pic2-b{position: relative;float: left;}
        .pic .pic2 .pic2-b .two{width: 400px;height: 200px;}
        .pic .pic2 .pic2-b .show{position: absolute;top: 0;left: 0;width: 400px;height: 200px;background: url("/Public/Media/image/medal.png") left top repeat;display: none;}
        .pic .pic2 .pic2-b .show a{font-size: 16px;display: block;color: #fff;text-align: center;width: 400px;height: 200px;line-height: 200px;}
        .pic .pic2 .pic2-b:hover .show{display: block;}
        .pic .pic3{width: 300px;height: 400px;float: left;position: relative;}
        .pic .pic3 a{display: inline-block;}
        .pic .pic3 .show{position: absolute;top: 0;left: 0;width: 300px;height: 400px;background: url("/Public/Media/image/medal.png") left top repeat;display: none;}
        .pic .pic3 .show .show-content{width: 300px;height: 400px;line-height: 400px;}
        .pic .pic3 .show .show-content a{font-size: 16px;display: block;color: #fff;text-align: center;}
        .pic .pic3:hover .show{display: block;}
        .pic .pic4{width: 200px;height: 400px;float: left;position: relative;}
        .pic .pic4 a{display: inline-block;}
        .pic .pic4 .show{position: absolute;top: 0;left: 0;width: 200px;height: 400px;background: url("/Public/Media/image/medal.png") left top repeat;display: none;}
        .pic .pic4 .show .show-content{width: 200px;height: 400px;line-height: 400px;}
        .pic .pic4 .show .show-content a{font-size: 16px;display: block;color: #fff;text-align: center;}
        .pic .pic4:hover .show{display: block;}
        .tjyouxi .youxi-b ul li .show{height: 172px;cursor: pointer;}
    </style>
...
<div id="box" style="width: 1920px;position: relative;left:50%;margin-left:-960px;">
   ...
   <?php if(is_array($carousel)): $i = 0; $__LIST__ = $carousel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lun): $mod = ($i % 2 );++$i;?><a href="<?php echo ($lun["url"]); ?>" target="<?php echo ($lun["target"]); ?>" title="<?php echo ($lun["title"]); ?>"><img src="<?php echo (get_cover($lun["data"],'path')); ?>" alt="<?php echo ($lun["title"]); ?>" title="" /></a><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="pic clearfix">
        <div class="pic1">
            <a href="javascript:void(0);"  target="<?php echo ($left_top['0']['target']); ?>"><img src="<?php echo (get_cover($left_top['0']['data'],'path')); ?>" alt=""></a>
            <div class="show">
        ...
        <div class="pic2">
            <div class="pic2-t">
                <a class="one" href="javascript:void(0);"  target="<?php echo ($mid_top['0']['target']); ?>"><img src="<?php echo (get_cover($mid_top['0']['data'],'path')); ?>" alt=""></a>
                <div class="show">
                    <a href="<?php echo ($mid_top['0']['url']); ?>"><?php echo ($mid_top['0']['title']); ?></a>
                </div>
            </div>
            <div class="pic2-b">
                <a class="two" href="javascript:void(0);"  target="<?php echo ($mid_top['1']['target']); ?>"><img src="<?php echo (get_cover($mid_top['1']['data'],'path')); ?>" alt=""></a>
                <div class="show">
        ...
        <div class="pic3">
            <a href="javascript:void(0);" target="<?php echo ($left_top['1']['target']); ?>"><img src="<?php echo (get_cover($left_top['1']['data'],'path')); ?>" alt=""></a>
            <div class="show">
                <div class="show-content">
        ...
        <div class="pic4">
            <a href="javascript:void(0);" target="<?php echo ($rig_top['0']['target']); ?>"><img src="<?php echo (get_cover($rig_top['0']['data'],'path')); ?>" alt=""></a>
            <div class="show">
                <div class="show-content">
...
<div class="tjyouxi clearfix">
    <div class="container">
        <div class="title_box">
            <p class="tit_name">推荐游戏</p>
            <a class="more_link" href="<?php echo U('Game/youxi');?>"><span>更多&gt;&gt;</span></a>
        </div>
        <!--<div class="youxi-t">
        ...
        <div class="youxi-b">
            <ul>
                ...
                <?php if(is_array($recommend)): $i = 0; $__LIST__ = $recommend;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    ...
                    <div class="show" onclick="window.location.href='<?php echo U('Game/yxchildren?id='.$vo['id'].'');?>'">
                        <div class="show-t">
                            <p><?php echo ($vo["game_name"]); ?></p>
                        </div>
                        <div class="show-b">
                            <img src="<?php echo U('Game/dow_url_generate?game_id='.$vo['id']);?>" alt="">
                            <a href="javascript:;" class="tj">推荐 <br/> &nbsp;<img src="/Public/Media/image/main/tuijian_wujiaoxing.png" alt=""></a>
    ...
    <div class="container">
        ...
        <div class="game-left clearfix">
            ...
            <div class="zixun clearfix">
                ...
                <div class="title_box">
                    <p class="tit_name">游戏资讯</p>
                    <a class="more_link" href="<?php echo U('Category/zixun');?>"><span>更多&gt;&gt;</span></a>
                </div>
        ...
        <div class="game-right clearfix">
            ...
            <div class="libao clearfix">
                <div class="title_box">
                    <p class="tit_name">游戏礼包</p>
                    <a class="more_link" href="<?php echo U('Gift/index');?>"><span>更多&gt;&gt;</span></a>
                </div>
                <!--<div class="libao-t">
            ...
            <!--<div class="kaifu clearfix" style="position: relative;">
                <div class="title_box">
                    <p class="tit_name">游戏开服</p>
                </div>
                &lt;!&ndash;<div class="kaifu-t">
...
<div class="footer clearfix">
    <div class="banxin">
        <div class="footer-t">
            <p>
                <a href="http://www.zhishengwh.com/media.php?s=/Category/zxchildren/id/35" target="_blank">关于我们 ｜  </a>
                <a href="http://www.zhishengwh.com/media.php?s=/Category/zxchildren/id/36" target="_blank">商务合作 ｜  </a>
                <a href="http://www.zhishengwh.com/media.php?s=/Category/zxchildren/id/37" target="_blank">合作伙伴 ｜  </a>
                <a href="http://www.zhishengwh.com/media.php?s=/Service/kefu" target="_blank">客服帮助</a>
            </p>
            <p>
                <a href="http://www.zhishengwh.com/media.php?s=/Index/regareement" target="_blank">注册协议｜ </a>
                <a href="http://www.zhishengwh.com/media.php?s=/Public/register" target="_blank">防沉迷系统 ｜ </a>
                <a href="http://www.zhishengwh.com/media.php?s=/Category/zxchildren/id/38" target="_blank">未成年家长监护工程 ｜ </a>
                <a href="http://www.zhishengwh.com/media.php?s=/Index/interareement" target="_blank">《网络游戏服务格式化协议必备条款》 </a>
            </p>
            <p>
                <a href="javascript:;">
                    深圳致晟文化创新有限公司 版权所有2019 zhishengwh.com
                </a>
            </p>
            <p><a href="http://www.miitbeian.gov.cn">网站备案：粤ICP备18083935号-1</a></p>
        </div>
    ...
    $(function(){
        ...
        $search.click(function(){
            ...
            if(txt == ''){
                ...
                window.location.href="/index.php?s=/Media/"+"Game/yx_fenlei/keyword/"+txt;
            }
            /*$.ajax({
             type: 'POST',
             async: true,
