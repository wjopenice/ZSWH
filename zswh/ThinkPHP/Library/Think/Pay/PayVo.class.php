...
class PayVo {
    ...
    /**
     * 设置渠道昵称
     * @param type $promote_nickname
     * @return \Think\Pay\PayVo
     */
    public function setPromoteNickname($promote_nickname) {
        $this->_promoteNickname = $promote_nickname;
        return $this;
    }
    /**
     * 设置上游渠道ID
    ...
    /**
     * 设置上游渠道名称
     * @param type $parent_account
     * @return \Think\Pay\PayVo
     */
    public function setParentAccount($parent_account) {
        $this->_parentAccount = $parent_account;
        return $this;
    }
    /**
     * 获取渠道昵称
     ...
     * @return \Think\Pay\PayVo
     */
    public function getPromoteNickname($promote_nickname) {
        $this->_promoteNickname = $promote_nickname;
        return $this;
    }
    /**
     ...
     * @return \Think\Pay\PayVo
     */
    public function getParentAccount($parent_account) {
        $this->_parentAccount = $parent_account;
        return $this;
    }
    /**
