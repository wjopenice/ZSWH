<?php
require_once 'notification/android/AndroidBroadcast.php';
require_once 'notification/android/AndroidFilecast.php';
require_once  'notification/android/AndroidGroupcast.php';
require_once  'notification/android/AndroidUnicast.php';
require_once  'notification/android/AndroidCustomizedcast.php';
class Sms {
