...
class Page
{
    ...
    public function show($searchData = ""){
        $str = "";
        $str .= "<style>.pagination{overflow:hidden;margin:20px 10px;} .pagination a{border: solid 1px #5f5f5f;color: #3b6391 ;  display: inline-block; text-decoration: none; padding: 5px 10px;height: 20px;line-height: 20px;}li{float: left;}</style>";
